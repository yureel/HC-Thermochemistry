...
class InputArguments:
    def __init__(self):
        ...
        # self.input_file = self.dir + "ab_initio_database_radical.csv"
        # self.model_path = self.dir + "run_0/none"
        # self.output_dir = self.dir + "run_0/results"
        # self.split = "cross-validation"  # random or scaffold or cross-validation or train_only
        ...
        self.pretraining_path = [self.dir + f'run_g4_rad_s7_3_600_3_100_700/results/fold_0/model0/model.pt'
                                 for j in range(self.num_models)]
        
        self.pretraining_fix = "none"  # mpn or ffn or none or onlylast
